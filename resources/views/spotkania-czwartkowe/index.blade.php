    ...
    <div class="grid gap-6">
      ...
      <div
        ...
        <div class="w-full">
          ...
          <h2 class="mt-6 text-xl font-semibold text-gray-900">Ciasto, ciastka, coś na stół</h2>
          ...
          <form>
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2 w-full">
              <div>
                <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Imię i
                  nazwisko</label>
              ...
              <div>
                <label for="password"
                  class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Przyniosę</label>
          ...
          <p class="text-gray-500 leading-relaxed flex items-center">
            2. Basia Śmiała - ciastka
            <a href="#" class="text-sm text-gray-400 hover:text-red-400 pl-4">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="w-5 h-5">
                <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <div class="grid gap-6">
      ...
      <div
        ...
        <div>
          ...
          <h2 class="mt-6 text-xl font-semibold text-gray-900">Przygotowanie salki przed spotkaniem</h2>

          <p class="mt-4 text-gray-500 text-sm leading-relaxed">
            Przygotowanie salki (łącznika) można rozpocząć od godziny 17:00. Klucze do łącznika można pobrać od Pana
            Kościelnego.
          </p>
      ...
      <div
        ...
        <div>
          ...
          <h2 class="mt-6 text-xl font-semibold text-gray-900">Sprzątanie salki po spotkaniu</h2>
